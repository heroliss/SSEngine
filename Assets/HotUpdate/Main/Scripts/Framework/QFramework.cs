...
namespace QFramework
{
    ...
    public abstract class Architecture<T> : IArchitecture where T : Architecture<T>, new()
    {
        ...
        static void MakeSureArchitecture()
        {
            if (mArchitecture == null)
            {
                ...
                //mArchitecture.mContainer.InjectAll(); //为所有已注册的实例注入实例

                foreach (var architectureModel in mArchitecture.mModels)
                {
                    mArchitecture.mContainer.Inject(architectureModel);
                ...
                {          
                    mArchitecture.mContainer.Inject(architectureSystem);
        ...
        private QFrameworkContainer mContainer = new QFrameworkContainer();

        public void RegisterSystem<TSystem>(TSystem system) where TSystem : ISystem
        {
            system.SetArchitecture(this);
            //mContainer.Register<TSystem>(system);
            mContainer.RegisterInstance(typeof(TSystem), system, false);
        ...
        public void RegisterModel<TModel>(TModel model) where TModel : IModel
        {
            ...
            mContainer.RegisterInstance(typeof(TModel), model, false);
        ...
        public void RegisterUtility<TUtility>(TUtility utility) where TUtility : IUtility
        {
            ...
            mContainer.RegisterInstance(typeof(TUtility), utility, false);
        }

        public TSystem GetSystem<TSystem>() where TSystem : class, ISystem
        {
            //return mContainer.Get<TSystem>();
            return (TSystem)mContainer.Resolve(typeof(TSystem), null, true);
        }

        public TModel GetModel<TModel>() where TModel : class, IModel
        {
            //return mContainer.Get<TModel>(); 
            return (TModel)mContainer.Resolve(typeof(TModel), null, true);
        }

        public TUtility GetUtility<TUtility>() where TUtility : class, IUtility
        {
            //return mContainer.Get<TUtility>();
            return (TUtility)mContainer.Resolve(typeof(TUtility), null, true);
        }
    ...
    public interface ISystem : IBelongToArchitecture, ICanSetArchitecture, ICanGetModel, ICanGetUtility,
        ICanRegisterEvent, ICanSendEvent, ICanGetSystem, IDisposable
    {
        void Init();
    }
